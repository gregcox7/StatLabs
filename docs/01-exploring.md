...
```
## `summarise()` has grouped output by 'sex', 'class'. You can override using the `.groups` argument.
```
...
<img src="01-exploring_files/figure-html/unnamed-chunk-10-1.png" width="672" />
