...
RStudio is an interface that makes it easier to work with the R language, and it is also free and can be installed on computers running any modern operating system (Windows, Mac, Linux, etc.).  R and RStudio are both already installed on the computers in the Technology-Enhanced Classrooms and the Library Public Computing Sites on campus.  If you are working on your own computer, you will have an easier time of it if you install RStudio on it.  Installing RStudio requires installing R first.
...
Once you have RStudio up and running, try the following line of code.
...
::: {.exercise}
Write code to answer the question, "which Class (1st, 2nd, or 3rd) had the highest proportion of survivors?"  Again, you will find it helpful to start from code we already used and modify it accordingly.

What code did you use?  And which Class had the highest proportion of survivors?
...
Attach a copy of the bar chart you made.  You can do this using the "Export" menu in the "Plots" pane in RStudio.
...
Instead, we should decide how big or small we want those ranges to be.  The following code tells R to make our histogram using "bins" that are 10 years "wide" (0-9, 10-19, etc.):
...
::: {.exercise}
Try making several different histograms of passenger age with different bin widths by changing the number "10" in the code above to different values.  Find a bin width that you believe gives the best visual summary of the age distribution across passengers.  Why do you think the bin width you chose is best?  Attach a copy of the histogram you made using your favorite bin width.
