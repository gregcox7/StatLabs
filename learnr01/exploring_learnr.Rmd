...
As you follow along in this activity, you will be asked to run bits of code in RStudio.  The code will appear in special boxes, like the one below.  The code in the box below will add the numbers 2 and 3.  When you run it, the result will appear directly below the box.  Try playing around with the code in the box and see how the result changes when you run it.

```{r two_plus_three, exercise = TRUE}
2 + 3
```
